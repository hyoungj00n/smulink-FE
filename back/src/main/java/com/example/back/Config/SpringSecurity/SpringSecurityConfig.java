package com.example.back.Config.SpringSecurity;
...
public class SpringSecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(HttpSecurity httpSecurity) throws Exception {
        ...
        return httpSecurity
                ...
                .cors().and()
                .authorizeRequests()
                //.antMatchers("/**").permitAll()//로그인은 접근 허용
                .antMatchers(HttpMethod.POST, "/api/users/category").authenticated()//인증 필요로 접근 막기
                .and()
                .sessionManagement()
